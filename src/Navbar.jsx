...
import DeskCompany from "./DeskCompany";
...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center font-[epilogue] justify-between mx-[2rem] lg:mx-[3rem] pt-[2rem]">
      ...
      {activeMenu && (
        <AnimatePresence>
          <motion.ul
            ...
            className="absolute text-Almost-Black bg-Almost-White right-0 top-[-3rem] h-[100vh] w-[60vw] text-start flex flex-col justify-center gap-[1.7rem] px-[2rem] lg:hidden"
          >
            <Features />
            <Company />
            <li>
            ...
            <div className="flex items-center justify-center flex-col pl-[0rem] mx-auto gap-[1.6rem] pt-[1.3rem]">
              <li>
                <a href="/">Login</a>
              </li>
              <li className="border-2 rounded-lg px-[3.2rem] py-[0.7rem]">
                <a href="/">Register</a>
              </li>
            </div>
          </motion.ul>
      ...
      <div className="z-10">
        <button onClick={showMenu} className=" text-[1.4rem] text-Almost-Black lg:hidden">
        ...
        <ul className="hidden z-50 ml-[-65vw] hover:text-Almost-Black lg:flex items-center justify-start gap-[4rem] text-Medium-Gray" >
            <DeskFeatures />
            <DeskCompany />
        ...
        <ul className="items-center justify-center gap-[3rem] hidden lg:flex">
            <li className="text-Medium-Gray hover:text-Almost-Black"><a href="/">Login</a></li>
            <li className="border-2 border-Medium-Gray hover:border-Almost-Black rounded-2xl text-Medium-Gray hover:text-Almost-Black px-[1.5rem] py-[0.5rem]"><a href="/">Register</a></li>
        </ul>
    </div>
  );
};
