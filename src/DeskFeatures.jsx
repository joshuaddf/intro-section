  ...
  return (
    <div>
      <div className=" gap-[1rem] relative">
        <button onClick={showList}>Features</button>
      ...
      {activeList && (
        ...
        transition={{ duration: 0.3 }}
         className="flex items-start bg-Almost-White ml-[-5rem] mt-[1rem] pl-[1rem] pb-[2rem] justify-center flex-col gap-[1rem] pt-[2rem] rounded-2xl shadow-Medium-Gray shadow-small w-[11rem] text-center">
